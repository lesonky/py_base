...
class UserMixin(FlaskLoginUserMixin):
    ...
    def get_id(self) -> str:
        ...
        user_id = self.id
        password_ends_with = '' if user_manager.USER_ENABLE_AUTH0 else self.password[
            -8:]
    ...
    def get_user_by_token(cls, token, expiration_in_seconds=None):
        ...
        if data_items:
            ...
            user_password = '' if user_manager.USER_ENABLE_AUTH0 else user.password[
                -8:]
    ...
    def has_roles(self, *requirements):
        ...
        role_names = self.get_user_roles(self)
